...
import type { FileStorage, ViewPlan } from '../../core';
...
function RuntimeHarness(props?: {
  ...
  React.useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      applyViewPlan(plan); }, 0);

    return () => {
      clearTimeout(timer);
      unregister(); }; }, [applyViewPlan, registerTool]);

  return (
    <AdaptiveRenderer
      spec={viewState.currentSpec ?? viewState.context.candidateSpec ?? null }
