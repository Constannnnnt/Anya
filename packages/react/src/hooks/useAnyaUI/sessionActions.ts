...
export async function finishAgentSessionRun(
  ...
  run: import('@anya-ui/core').AgentSessionRun,
  publishView: (
    spec: import('@anya-ui/core').ViewSpec,
  ...
  let appView: import('@anya-ui/core').AppView | undefined;
  ...
  let viewTemplate: import('@anya-ui/core').ViewTemplate | undefined;
...
export async function createDraftFromRecommendationRun(
  ...
  runAgentSession: (input: {
    ...
    transport?: import('@anya-ui/core').AgentSessionTransport;
...
export function applyReviewedDraftToApp(
  ...
  openAppView: (viewId: string) => import('@anya-ui/core').AppView | undefined,
): AppliedViewChangeToAppResult {
...
export function applyReviewedDraftToTemplate(
  ...
  ) => import('@anya-ui/core').ResolvedView | undefined,
): AppliedViewChangeToTemplateResult {
