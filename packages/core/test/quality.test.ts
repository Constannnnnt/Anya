    ...
    const records: ActionResult[] = [
      {
        ...
        lane: 'optimistic',
        risk: 'safe',
        interaction: { timestamp: 1, elementId: 'a', componentName: 'Button', action: 'click' },
      },
      {
        bindingId: 'b-2',
        status: 'error',
        ...
        rolledBack: true,
        error: 'tool failed',
        interaction: { timestamp: 2, elementId: 'a', componentName: 'Button', action: 'click' },
      },
      {
        bindingId: 'b-3',
        status: 'skipped',
        ...
        interaction: { timestamp: 3, elementId: 'a', componentName: 'Button', action: 'click' },
      },
      {
        bindingId: 'b-4',
        status: 'success',
        ...
        lane: 'confirmed',
        risk: 'risky',
        interaction: { timestamp: 4, elementId: 'a', componentName: 'Button', action: 'click' },
      },
      {
        bindingId: 'b-5',
        status: 'success',
        ...
        lane: 'optimistic',
        risk: 'safe',
        interaction: { timestamp: 5, elementId: 'a', componentName: 'Button', action: 'click' },
      },
    ];
