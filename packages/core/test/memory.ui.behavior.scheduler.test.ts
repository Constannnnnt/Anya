...
import { createBehaviorFinding, type BehaviorAnalyzer } from '../src/memory/ui/behavior/analyzers';
import { BehaviorAnalyzerRegistry } from '../src/memory/ui/behavior/analyzerRegistry';
import { BehaviorDirtyTracker } from '../src/memory/ui/behavior/dirtyTracker';
import {
  BehaviorAnalysisScheduler,
  DEFAULT_BEHAVIOR_SCHEDULER_POLICY,
} from '../src/memory/ui/behavior/scheduler';
import {
