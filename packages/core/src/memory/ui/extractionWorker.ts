/**
 * @anya-ui/core — Extraction Worker
 *
...
- **Action**: Which tools were used, what components were selected, and in what sequence. If no tools, describe the response.
- **Thought**: Why these tools/components were chosen, how arguments were determined, and what guided the decision-making.
...
JSON array, one object per turn:
{
  ...
  "action": "Tools used, components selected, sequence of execution",
